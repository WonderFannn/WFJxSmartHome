...
import com.jinxin.datan.net.protocol.CustomerMusicLibList;
 ...
 * @company 金鑫智慧
 */
public class CustomerMusicLibListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerMusicLibListTask(Context context,int page, int rows) {
		this.page = page;
		this.rows = rows;
		this.init();
	...
	private void init() {
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerMusicLibList(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_CUSTOMER_PRODUCT_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
