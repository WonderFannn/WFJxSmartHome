 ...
 * @company 金鑫智慧
 */
public class RemoteDeviceTypeListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public RemoteDeviceTypeListTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new RemoteDeviceTypeListRj(this,
				requestBytes));
	}
