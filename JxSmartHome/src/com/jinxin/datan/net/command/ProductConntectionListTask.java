...
import com.jinxin.datan.net.protocol.ProductConnectionListRj;
 ...
 * @company 金鑫智慧
 */
public class ProductConntectionListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public ProductConntectionListTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new ProductConnectionListRj(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_PRODUCT_CONNECTION,ControlDefine.DEFAULT_UPDATE_TIME);
