...
import com.jinxin.datan.net.protocol.CustomerPatternCMDList;
 ...
 * @deprecated
 */
public class CustomerPatternCMDListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerPatternCMDListTask(Context context,String patternId) {
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerPatternCMDList(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_CUSTOMER_PATTERN_CMD_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
