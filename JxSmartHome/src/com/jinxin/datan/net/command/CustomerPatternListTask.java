...
import com.jinxin.datan.net.protocol.CustomerPatternList;
 ...
 * @company 金鑫智慧
 */
public class CustomerPatternListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerPatternListTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerPatternList(this,
				requestBytes));
	}
