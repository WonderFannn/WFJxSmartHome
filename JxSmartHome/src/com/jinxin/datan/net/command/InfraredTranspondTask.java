...
import com.jinxin.datan.net.protocol.InfraredTranspondRj;
 ...
 * @company 金鑫智慧
 */
public class InfraredTranspondTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public InfraredTranspondTask(Context context, int fundId) {
		this.fundId=fundId;
		this.init();
	...
	private void init() {
		...
		try {
			Header header = new Header(ControlDefine.INFRARED_TRANSPORT_TEST_BIPCODE,
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new InfraredTranspondRj(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_CUSTOMER_PATTERN_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
		...
		serviceContent.put("fundId", fundId);
