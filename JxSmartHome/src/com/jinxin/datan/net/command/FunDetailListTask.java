 ...
 * @company 金鑫智慧
 */
public class FunDetailListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public FunDetailListTask(Context context) {
		this.init();
	...
	private void init() {
		...
		try {
			Header header = new Header(ControlDefine.BS_FUN_MANAGER,
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new FunDetailList(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_FUN_DETAIL_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
