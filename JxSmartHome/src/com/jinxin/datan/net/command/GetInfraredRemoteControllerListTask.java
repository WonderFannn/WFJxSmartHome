...
import com.jinxin.datan.net.protocol.GetInfraredRemoteControllerListRJ;
import com.jinxin.datan.net.protocol.RemoteDeviceTypeListRj;
 ...
 * @company 金鑫智慧
 */
public class GetInfraredRemoteControllerListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public GetInfraredRemoteControllerListTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new GetInfraredRemoteControllerListRJ(this,
				requestBytes));
	}
