...
import com.jinxin.datan.net.protocol.FunDetailConfigList;
import com.jinxin.datan.net.protocol.FunDetailList;
 ...
 * @company 金鑫智慧
 */
public class FunDetailConfigTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public FunDetailConfigTask(Context context) {
		this.init();
	...
	private void init() {
		...
		try {
			Header header = new Header(ControlDefine.BS_FUN_CONFIG,
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new FunDetailConfigList(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_PRODUCT_FUN_DETAIL_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
