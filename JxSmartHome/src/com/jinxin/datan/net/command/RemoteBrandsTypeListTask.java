...
import com.jinxin.datan.net.protocol.RemoteBrandsTypeListRj;
 ...
 * @company 金鑫智慧
 */
public class RemoteBrandsTypeListTask extends InternetTask {
	 ...
	 * @param context
	 */
	public RemoteBrandsTypeListTask(Context context, int deviceId) {
	...
	private void init() {
		...
		try {
			Header header = new Header(ControlDefine.BS_DEVICE_BRANDS,
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new RemoteBrandsTypeListRj(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_REMOTE_BRANDS,ControlDefine.DEFAULT_UPDATE_TIME);
