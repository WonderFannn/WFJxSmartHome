...
import com.jinxin.datan.net.protocol.SysUserDetailRJ;
 ...
 * @company 金鑫智慧
 */
public class SysUserDetailTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public SysUserDetailTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new SysUserDetailRJ(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_USER_DETAIL_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
