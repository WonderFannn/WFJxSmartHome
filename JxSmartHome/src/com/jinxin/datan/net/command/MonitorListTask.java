...
import com.jinxin.datan.net.protocol.MonitorList;
 ...
 * @company 金鑫智慧
 */
public class MonitorListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public MonitorListTask(Context context,String code) {
		this.code = code;
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new MonitorList(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_MONITOR_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
