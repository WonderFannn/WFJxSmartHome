...
import com.jinxin.datan.net.protocol.CustomerMatchCodeRj;
 ...
 * @company 金鑫智慧
 */
public class CustomerMatchCodeTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerMatchCodeTask(Context context, String whId, int deviceId) {
		this.whId = whId;
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerMatchCodeRj(this,
				requestBytes));
	}
