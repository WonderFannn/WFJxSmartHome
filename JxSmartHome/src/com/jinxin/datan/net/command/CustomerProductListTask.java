 ...
 * @company 金鑫智慧
 */
public class CustomerProductListTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerProductListTask(Context context) {
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerProductList(this,
				requestBytes));
	}
