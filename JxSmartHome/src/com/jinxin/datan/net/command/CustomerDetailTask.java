...
import com.jinxin.datan.net.protocol.CustomerDetail;
 ...
 * @company 金鑫智慧
 */
public class CustomerDetailTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public CustomerDetailTask(Context context) {
		this.init();
	...
	private void init() {
		...
		try {
			Header header = new Header(ControlDefine.BS_USER_MANAGER,
					ControlDefine.TRD_USER_DETAIL, ControlDefine.ACTION_REQUEST,
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new CustomerDetail(this,
				requestBytes));
	}
	...
	private JSONObject createServiceContent() throws JSONException {
		...
		String _updateTime = SharedDB.loadStrFromDB(_account, ControlDefine.KEY_CUSTOMER_DETAIL_LIST,ControlDefine.DEFAULT_UPDATE_TIME);
