 ...
 * @company 金鑫智慧
 */
public class AddCustomerRemoteBrandTask extends InternetTask {
	 ...
	 * @param context
	 */
	public AddCustomerRemoteBrandTask(Context context, String mCode, String whId, int deviceId, String nickName, int brandsId, int type) {
		this.mCode = mCode;
		this.whId = whId;
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new AddCustomerRemoteBrandRj(this,
				requestBytes));
	}
