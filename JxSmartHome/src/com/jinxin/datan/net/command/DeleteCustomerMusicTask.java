...
import com.jinxin.datan.net.protocol.DeleteCustomerMusicRJ;
 ...
 * @company 金鑫智慧
 */
public class DeleteCustomerMusicTask extends InternetTask {
	/**
	 * 请求任务
	 */
	 ...
	 * @param context
	 */
	public DeleteCustomerMusicTask(Context context, int id) {
		this.id = id;
		this.init();
...
//			
		...
		this.request = new NetRequest(DatanAgentConnectResource.HTTP_ACCESSPATH, new DeleteCustomerMusicRJ(this,
				requestBytes));
	}
