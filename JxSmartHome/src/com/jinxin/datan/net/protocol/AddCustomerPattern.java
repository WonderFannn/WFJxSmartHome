 ...
 * @company 金鑫智慧
 */
public class AddCustomerPattern extends ResponseJson {
	private Task task = null;
	private byte[] requestBytes;
	
	public AddCustomerPattern(Task task, byte[] requestBytes) {
		this.task = task;
...
//					}
					patternId = this.getJsonInt(jsonObject, "serviceContent");
					///////////////////////////////////////
					isSuccess = true;
				}
				...
				isSuccess = false;
				 ...
				 if(isSuccess){
			            this.task.callback(Integer.toString(patternId));
			        }else{
