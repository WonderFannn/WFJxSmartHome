 ...
 * @company 金鑫智慧
 */
public class DownLoadImage extends CommandBase {
	 ...
	 * 
	 */
	public DownLoadImage(Task task, String url, int saveType, boolean isHide) {
		this.task = task;
		this.url = url;
	...
	public boolean fromInput(InputStream is) {
		...
		String _path = FileManager.instance().getImagePath(this.url,
