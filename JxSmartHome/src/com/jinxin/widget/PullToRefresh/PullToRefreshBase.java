...
import com.jinxin.widget.PullToRefresh.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     */
    public void doPullRefreshing(final boolean smoothScroll, final long delayMillis,final boolean isDoPullDown) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
