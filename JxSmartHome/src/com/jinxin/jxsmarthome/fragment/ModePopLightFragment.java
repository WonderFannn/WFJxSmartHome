...
public class ModePopLightFragment extends DialogFragment  implements OnClickListener, OnSeekBarChangeListener {
	FrameLayout panel;
	...
	private void initData() {
		...
		if (isChanged) {
			...
			if (_productFunVO != null
			    ...
			    String operation = _productFunVO.getProductPatternOperation().getOperation(); 
