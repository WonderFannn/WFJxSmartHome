...
public class ModeThreeSocketFragment extends DialogFragment implements OnSwitchCheckBoxClickListener {

	/**
	 * 开关列表
	 */
	private ListView lvThreeSwitch;
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		((BaseActionBarActivity) getActivity()).getSupportActionBar().setTitle("配置三路开关");
	}
...
//			if (funDetail.getFunType().equals(ProductConstants.FUN_TYPE_THREE_SWITCHES[i])) {
//				switchStatus = new boolean[i + 3];
//				switchEnableStatus = new boolean[i + 3];
//			}
//		}
		switchStatus = new boolean[3];
		switchEnableStatus = new boolean[3];
	...
	private void initView(View view) {
		lvThreeSwitch = (ListView) view.findViewById(R.id.lv_five_switch);
		switchListAdapter = new ModeFiveSwitchListAdapter(this, funDetail, switchEnableStatus, switchStatus);
		lvThreeSwitch.setAdapter(switchListAdapter);
	}
