...
public class ConnectionThreeSwitchFragment extends DialogFragment implements OnSwitchCheckBoxClickListener {
		...
		if (connectionVO != null) {
			...
			if (!TextUtils.isEmpty(opreationDesc)) {
				try {
					...
					String key;
					String value;
					if (ProductConstants.FUN_TYPE_THREE_SWITCH_THREE.equals(funtype)
