...
public class UpdateMessageBox extends Dialog {
	...
	public UpdateMessageBox(Context context, String title, String content, int type) {
		super(context, R.style.dialog);
		setContentView(CommDefines.getSkinManager().view(R.layout.message_box));
	...
	public UpdateMessageBox(Context context, int title, int content, int type) {
		super(context, R.style.dialog);
		setContentView(CommDefines.getSkinManager().view(R.layout.message_box));
