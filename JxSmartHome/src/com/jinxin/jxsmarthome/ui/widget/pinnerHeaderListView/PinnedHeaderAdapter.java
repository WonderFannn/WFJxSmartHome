// @author Bhavya Mehta
package com.jinxin.jxsmarthome.ui.widget.pinnerHeaderListView;
...
import com.jinxin.jxsmarthome.activity.RemoteBrandsTypeActivity.ListFilter;
...
public class PinnedHeaderAdapter extends BaseAdapter implements OnScrollListener, IPinnedHeader, Filterable {
	...
	// 对应的拼音list
	ArrayList<String> mEngItems;


	// context object
	Context mContext;

	public PinnedHeaderAdapter(Context context, ArrayList<String> listItems, ArrayList<String> engItems,ArrayList<Integer> listSectionPos) {
		this.mContext = context;
		this.mListItems = listItems;
		this.mEngItems = engItems;
...
//		String listChar = mListItems.get(position).toString().substring(0, 1).toUpperCase(Locale.getDefault());
		String listChar = mEngItems.get(position).toString().substring(0, 1).toUpperCase(Locale.getDefault());
	...
	public Filter getFilter() {
		return ((RemoteBrandsTypeActivity) mContext).new ListFilter();
	}
