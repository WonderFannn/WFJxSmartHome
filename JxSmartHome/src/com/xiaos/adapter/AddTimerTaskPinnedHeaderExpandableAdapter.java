...
public class AddTimerTaskPinnedHeaderExpandableAdapter extends  BaseExpandableListAdapter implements HeaderAdapter{
	...
	public AddTimerTaskPinnedHeaderExpandableAdapter(List<List<WHproductUnfrared>> childrenData,List<ProductFunVO> groupData
		...
		initData(groupData);
//		System.out.println("===grop"+groupData.hashCode());
		...
		this.mHandler = new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				case 0:
					...
					System.out.println("====ppp"+groupData.toString());
					break;
				default:
					break;
				}
	...
	public View getChildView(final int groupPosition, final int childPosition,
	    ...
	    checkBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if (isChecked) {
					if (productFunVO.getProductPatternOperations()!=null) {
						List<ProductPatternOperation> patternOperations=productFunVO.getProductPatternOperations();
						if (patternOperations.get(childPosition)!=null&&
								patternOperations.get(childPosition).getParaDesc()!=null&&
								patternOperations.get(childPosition).getParaDesc()!="0") {
        ...
        for (int i = 0; i < groupData.size(); i++) {
			ProductFunVO operation=groupData.get(i);
