...
public class AmendModePinnedHeaderExpandableAdapter extends  BaseExpandableListAdapter implements HeaderAdapter{
	...
	public AmendModePinnedHeaderExpandableAdapter(List<List<WHproductUnfrared>> childrenData,List<ProductFun> groupData
...
//        ProductPatternOperation operation=productFunVO.getProductPatternOperation();
